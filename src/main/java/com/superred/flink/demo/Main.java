...
//        streamingWindowWatermark2();
//        socketDemoFullCount(args);
        socketWindowWordCountJavaCheckPoint(args);
    }
     ...
     * @throws Exception
     */
    public static void socketWindowWordCountJavaCheckPoint(String[] args) throws Exception {
        //获取需要的端口号
        int port;
        try {
     ...
     * @throws Exception
     */
    public static void socketWindowWordCountJava(String[] args) throws Exception {
        //获取需要的端口号
        int port;
        try {
            ParameterTool parameterTool = ParameterTool.fromArgs(args);
     ...
     * @throws Exception
     */
    public static void socketDemoFullCount(String[] args) throws Exception {
        //获取需要的端口号
        int port;
        try {
            ParameterTool parameterTool = ParameterTool.fromArgs(args);
     ...
     * @throws Exception
     */
    public static void streamingWindowWatermark2() throws Exception {
        //定义socket的端口号
        int port = 9000;
        ...
        env.execute("eventtime-watermark-2");
